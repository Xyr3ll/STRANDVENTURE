...
namespace STRANDVENTURE.Migrations
{
    ...
    [Migration("20251002142953_AddStrandQuizIsLive")]
    partial class AddStrandQuizIsLive
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("STRANDVENTURE.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 2, 14, 29, 52, 846, DateTimeKind.Utc).AddTicks(1428),
                            Email = "superadmin@gmail.com",
                            IsActive = true,
                            Name = "Super",
                            PasswordHash = "PBKDF2-HMACSHA256.210000.iQzsABxQiSM7nYbHb3lssQ==./E3WIK5dWb4R1q+xCjSDVz6T8b8znP/xSKiA49TPwnM=",
                            Role = "SuperAdmin"
                        },
                        new
                        {
                            Id = new Guid("a26b9b24-c1ac-47de-9555-9c41571a7bff"),
                            CreatedAt = new DateTime(2025, 10, 2, 14, 29, 52, 870, DateTimeKind.Utc).AddTicks(4314),
                            Email = "teacher1@gmail.com",
                            IsActive = true,
                            Name = "Teacher 1",
                            PasswordHash = "PBKDF2-HMACSHA256.210000.iauNdHGpCLYd+xsT8UecIg==.hmPIa3CaubqeZ7QJHI6a3lAckVwx08z2+dwHC3Yu4WE=",
                            Role = "Teacher"
                        });
                });
            ...
            modelBuilder.Entity("STRANDVENTURE.Models.StrandQuizQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("StrandQuizId", "QuestionId")
                        .IsUnique();

                    b.ToTable("StrandQuizQuestions");
                });
