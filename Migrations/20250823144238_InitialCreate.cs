        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_Employees_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptionLetter = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "QuestionOptionStrandWeights",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionOptionStrandWeights", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuestionOptionStrandWeights_QuestionOptions_QuestionOptionId",
                        column: x => x.QuestionOptionId,
                        principalTable: "QuestionOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionOptionStrandWeights_Strands_StrandId",
                        column: x => x.StrandId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionOptions_QuestionId_OptionLetter",
                table: "QuestionOptions",
                columns: new[] { "QuestionId", "OptionLetter" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_QuestionOptionStrandWeights_QuestionOptionId_StrandId",
                table: "QuestionOptionStrandWeights",
                columns: new[] { "QuestionOptionId", "StrandId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_QuestionOptionStrandWeights_StrandId",
                table: "QuestionOptionStrandWeights",
                column: "StrandId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_QuestionOrder",
                table: "Questions",
                column: "QuestionOrder",
                unique: true);

            // Removed TeacherId index from Sections

            migrationBuilder.CreateIndex(
                name: "IX_SectionStudents_SectionId_StudentId",
